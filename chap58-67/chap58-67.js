...
//Q # 1 (iv)
document.getElementById('first-name').value = 'Sameer';

//Q # 1 (v)
document.getElementById('last-name').value = 'Faisal';

document.getElementById('emaill').value = 'sameerfaisal46@gmail.com';
